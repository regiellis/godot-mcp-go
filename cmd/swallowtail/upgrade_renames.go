...
//
//	swallowtail engine class-info --class TileMap --filter layer
//	swallowtail engine class-info --class TileMapLayer
//	swallowtail engine class-info --class GDExtension
//	swallowtail engine search --query close_library
//
