...
// form, which does see the open project, use swallowtail script validate.
func runCheck(args []string) int {
	...
	fs.Usage = subHelp(fs, "parse GDScript files cold, with no editor",
		[]string{"swallowtail check <file|dir>... [--jobs 4] [--project DIR] [--json]"},
...
of the editor's own script warnings. The in-editor form is swallowtail script
validate --path res://your/script.gd.

The full engine output for every file is written to
<project>/.godot/swallowtail-check.log.`)
