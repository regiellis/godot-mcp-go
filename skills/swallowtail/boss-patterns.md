...
```sh
swallowtail create --path ./boss-bed --name BossBed --install --enable
cd boss-bed && swallowtail launch

swallowtail script create --path res://boss/stats.gd            --content "..."
swallowtail script create --path res://boss/behaviour.gd        --content "..."
swallowtail script create --path res://boss/behaviour_container.gd --content "..."
swallowtail script create --path res://boss/phase_controller.gd --content "..."
swallowtail script create --path res://boss/boss.gd             --content "..."
swallowtail script create --path res://boss/behaviours/chase.gd --content "..."
swallowtail script create --path res://boss/behaviours/melee.gd --content "..."
swallowtail script create --path res://boss/behaviours/dash.gd  --content "..."

swallowtail scene create --path res://boss/boss.tscn --root-type Node2D --root-name Boss
swallowtail node add --type Node --name Stats --parent-path .
swallowtail node add --type Node --name Behaviours --parent-path .
swallowtail node add --type Node --name PhaseController --parent-path .
swallowtail script attach --node-path Stats --script-path res://boss/stats.gd
swallowtail script attach --node-path Behaviours --script-path res://boss/behaviour_container.gd
swallowtail script attach --node-path PhaseController --script-path res://boss/phase_controller.gd
swallowtail script attach --node-path . --script-path res://boss/boss.gd
swallowtail scene save

swallowtail editor reload            # class_name files need the rescan before validate
swallowtail script validate --all    # "failed": 0, "passed": 8
```
...
swallowtail runtime call --node-path Boss/Behaviours --method report
swallowtail runtime call --node-path Boss/Stats --method damage --args '[45]'
swallowtail runtime get  --node-path Boss/PhaseController --properties '["phase_index"]'
```
