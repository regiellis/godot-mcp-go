# Level design & spatial communication: building blockouts with swallowtail
...
```
swallowtail install-assets --pack kenney_prototype_textures   # -> res://assets/vendor/kenney_prototype_textures/
