# Godot game patterns, built with swallowtail
...
```sh
swallowtail script create --path res://content/content_db.gd --content "..."
swallowtail project add-autoload --name ContentDB --path res://content/content_db.gd
swallowtail editor reload && swallowtail scene play --mode main
swallowtail runtime eval --code 'var db = get_node("/root/ContentDB")
