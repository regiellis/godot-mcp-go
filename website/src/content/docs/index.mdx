...
Because the CLI talks to the *live* engine, an agent grounds itself on what Godot 4.7 actually supports before acting, instead of guessing from training memory.
